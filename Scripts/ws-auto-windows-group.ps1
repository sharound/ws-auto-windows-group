...
# More Details: https://github.com/wandersick/ws-auto-windows-group
...
Param(
    ...
    # - Example:  ws-auto-windows-group.ps1 -csvPath "C:\Folder\incoming.csv"
...
# ws-auto-windows-group -csvPath "C:\Folder\File.csv" -groupName "managers" -force $true
...
$inputMode = "Static"
    ...
    #       e.g. ws-auto-windows-group.ps1 -csvPath "C:\Folder\file.csv"
...
#       e.g. ws-auto-windows-group.ps1 -groupName "managers"
...
#       e.g. ws-auto-windows-group.ps1 -force $true
...
# If source file path (csvPath) is specified using command-line parameter (e.g. ws-auto-windows-group.ps1 -csvPath "C:\Folder\File.csv")
